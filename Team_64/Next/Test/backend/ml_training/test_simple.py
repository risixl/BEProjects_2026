...
class MockLSTMPredictor:
    """
    A mock LSTM predictor for testing purposes that generates synthetic stock data
    """
    ...
    def generate_mock_data(self, symbol, days=1000):
        ...
        for i in range(days - 1):
            ...
            prices.append(max(next_price, 1.0))  # Ensure price doesn't go below 1
    ...
    def train(self, symbol, epochs=50, test_size=0.2):
        ...
        try:
            ...
            self.last_data = data  # Store for prediction
            ...
            return {
                ...
                'model_type': 'MockLinearRegression'
            }
    ...
    def save_model(self, symbol, model_dir="models"):
...
def main():
    if len(sys.argv) != 2:
        print(json.dumps({
            'success': False,
            'error': 'Usage: python test_simple.py <SYMBOL>'
        }))
        return
    ...
    try:
        ...
        print(f"Training mock model for {symbol}...")
