...
def get_weather_data(
    ...
    try:
        ...
        try:
            ...
            print(f"Weather API error: {e} (status={status})\n{body}")
    ...
    if request.method == "POST":
        ...
        if no_of_day < 0:
            ...
            flash(
                ...
                "Return date should be greater than the Travel date (Start date).",
            ...
            try:
                ...
                weather_data = get_weather_data(
                    ...
                    api_key, destination, start_date, end_date
        ...
        # If weather failed, still render the itinerary with a fallback

        if not weather_data:

            flash("Weather data unavailable; showing itinerary only.", "warning")
        ...
        return render_template(
            ...
            "dashboard.html", weather_data=weather_data, plan=plan
...
def contact():
    ...
    return render_template(
        ...
        "contact.html", user_email=user_email, user_name=user_name, message=message
...
def login():
    ...
    if request.method == "POST":
        ...
        if user and user.check_password(password):
            ...
            flash(
                "Wrong email or password. Please try again or register now.", "danger"
            )
